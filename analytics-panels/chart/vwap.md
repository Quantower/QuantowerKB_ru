...
По умолчанию установлен параметр "**Текущий TF",** он не предоставит такой точности, как  **"Ticks"**, но при этом существенно будет уменьшено время на загрузку данных.
{% endhint %}
