...
Если Ваше оборудование не соответствует требованиям для оптимальной работы, то данная статья  не решит полностью проблему быстрой и качественной работы Quantower, но частично поможет оптимизировать работу и позволит пользователям с более слабой системой воспользоваться всеми преимуществами платформы при меньшей нагрузке.
...
С учетом больших объемов передаваемых и принимаемых данных, для скорости работы системы и непрерывной нормальной работы Quantower есть определенные требования к ПК.
