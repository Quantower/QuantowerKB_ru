...
Ниже описаны примеры самых популярных формул. Используя свой синтакис, Вы сможете получить  те данные, что нужны именно Вам для анализа и вставить в свою электронную таблицу. Так же Вы можете данные примеры загрузить с данного файла Excel.
