...
Возможности анализа данных в реальном режиме времени используя формулу **RTD** безграничны. Начиная от получения простых данных по котировкам, заканчивая полноценным и глубоким анализом рынка, с графиками и аналитикой. В данном разделе мы познакомим Вас с  основными возможностями, используя которые Вы сможете создать в  **Excel** свой пользовательский анализ данных:
