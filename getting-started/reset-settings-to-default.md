...
Поэтому можно пр заменить на другом ПК всю папку, либо на втором ПК сначала сохранить старые настройки, переименовав папку "Settings" на "Settings\_old". А после вставить папку "Settings"  с теми настройками, которые вы переносите с другого ПК.
