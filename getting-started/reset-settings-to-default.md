...
Скопируйте ее и вставьте в папку с платформой на другом ПК путем **замены.**  
При каждом запуске платформы  идет обращение к папке "Settings"  за настройками.  
Если ее нет с таким названием, то автоматически создается новая папка "Settings"  с настройками по умолчанию.
