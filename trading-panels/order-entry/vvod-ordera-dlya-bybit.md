...
* **Как создать ордер Bybit с панели ОЕ \(Ввода ордера\)**
  ...
  * Выбор объема ордера Параметры ордера - тип, TIF, цена, алгоритмические настройки TP \(тейк-профит\) и SL стоп лимит \(стоп-лосс\) ордера 
* Как создать ордер Bybit с панели быстрой торговли с графика 
  ...
  * Параметры ордера - тип, TIF, цена, алгоритмические настройки TP \(тейк-профит\) и SL стоп лимит \(стоп-лосс\) ордера
