...
-с панели ввода ордера \(для криптовалютных подключений так же с [панели ввода крипто-ордера\)](https://help.quantower.com.ru/trading-panels/crypto-order-entry)  
-
