...
Вторым шагом приготовим кнопку  **\[  \* 1,2   \]**  для быстрого изменения "шага объема". Как их настраивать мы описывали [**выше**](https://help.quantower.com.ru/trading-panels/vizualnyi-treiding#kak-nastroit-svoi-knopki-bystroi-smeny-summy-zakaza) в данной статье.

И на панели торговли с графика установим количество/объем для первого ордера. 
